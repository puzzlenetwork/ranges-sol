...
export default class RangePool extends BaseRangePool {
  ...
  constructor(
    ...
    super(instance, poolId, vault, tokens, weights, virtualBalances, swapFeePercentage, owner);
  ...
  static async create(params: RawRangePoolDeployment = {}): Promise<RangePool> {
    ...
    const { tokens, weights, virtualBalances, rateProviders, assetManagers, swapFeePercentage, owner } = deployment;
      ...
      args: [
        {
          ...
          virtualBalances: params.virtualBalances,
  ...
  static async _deployFromFactory(params: RangePoolDeployment, vault: Vault): Promise<Contract> {
    ...
    const { tokens, weights, virtualBalances, rateProviders, swapFeePercentage, owner, from } = params;
